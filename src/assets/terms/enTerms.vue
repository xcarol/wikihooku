<template>
  <v-card>
      ...
      >
        ...
        <v-list-item
          ><a
            ...
            >SendGrid</a
          >
          for sending emails</v-list-item
        >
        <v-list-item
          ><a
            ...
            >Render</a
          >
          for service execution</v-list-item
        >
        <v-list-item
          ><a
            ...
            >Github</a
          >
          for the project source code</v-list-item
        >
      </v-list>
    </v-card-text>

    <v-card-title>1. Data Storage</v-card-title>

    <v-card-text>
      WikiHooku stores user data in MongoDB services for the purpose of maintaining the information
      obtained and/or generated from the use of WikiHooku. This data does not include personally
      identifiable information and are kept in accordance with the terms of services of MongoDB.
    </v-card-text>
    ...
    <v-card-text>
      This legal notice is governed by the laws of the Spanish territory and any dispute that may
      arise in relation to this legal notice will be subject to the exclusive jurisdiction of courts
      of this territory.
    </v-card-text>

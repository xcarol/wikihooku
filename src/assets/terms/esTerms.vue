<template>
  <v-card-text>
    ...
    <v-card-title>0. Servicios utilizados</v-card-title>
      ...
      >
        <v-list-item
          ><a
            ...
            >MongoDb</a
          >
          para el almacenamiento de datos</v-list-item
        >
        <v-list-item
          ><a
            ...
            >SendGrid</a
          >
          para el envío de correos electrónicos</v-list-item
        >
        <v-list-item
          ><a
            ...
            >Render</a
          >
          para la ejecución del servicio</v-list-item
        >
        <v-list-item
          ><a
            ...
            >Github</a
          >
          para el código fuente del proyecto</v-list-item
        >
      </v-list>
    </v-card-text>

    <v-card-title>1. Almacenamiento de Datos</v-card-title>

    <v-card-text>
      WikiHooku almacena los datos de usuario en los servicios de MongoDB la finalidad de mantener
      la información obtenida y/o generada a partir del uso de WikiHooku. Estos datos no incluyen
      información personal identificable y se conservan de acuerdo con las condiciones de los
    ...
    <v-card-title>4. Ley Aplicable</v-card-title>

    <v-card-text>
      Este aviso legal se rige por las leyes del territorio español y cualquier controversia que
      pueda surgir en relación con este aviso legal estará sujeta a la jurisdicción exclusiva de los
      tribunales de ese territorio.
    </v-card-text>
    ...
    <v-card-text>
      Si tienes cualquier pregunta o inquietud relacionada con este aviso legal, por favor, ponte en
